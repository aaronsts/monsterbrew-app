...
export const ACTION_PRESETS = [
  {
    ...
    type: "action",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach ??? ft., one target. _Hit:_ [STR ???D???] ??? damage.",
  },
  {
    name: "Melee Weapon Attack (DEX)",
    type: "action",
    desc: "_Melee Weapon Attack:_ [DEX ATK] to hit, reach ??? ft., one target. _Hit:_ [DEX ???D???] ??? damage.",
  },
  {
    name: "Melee Spell Attack (INT)",
    type: "action",
    desc: "_Melee Spell Attack:_ [INT ATK] to hit, reach ??? ft., one target. _Hit:_ [INT ???D???] ??? damage.",
  },
  {
    name: "Melee Spell Attack (WIS)",
    type: "action",
    desc: "_Melee Spell Attack:_ [WIS ATK] to hit, reach ??? ft., one target. _Hit:_ [WIS ???D???] ??? damage.",
  },
  {
    name: "Melee Spell Attack (CHA)",
    type: "action",
    desc: "_Melee Spell Attack:_ [CHA ATK] to hit, reach ??? ft., one target. _Hit:_ [CHA ???D???] ??? damage.",
  },
  {
    name: "Ranged Weapon Attack (STR)",
    type: "action",
    desc: "_Ranged Weapon Attack:_ [STR ATK] to hit, range ???/??? ft., one target. _Hit:_ [STR ???D???] ??? damage.",
  },
  {
    name: "Ranged Weapon Attack (DEX)",
    type: "action",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range ???/??? ft., one target. _Hit:_ [DEX ???D???] ??? damage.",
  },
  {
    name: "Ranged Spell Attack (INT)",
    type: "action",
    desc: "_Ranged Spell Attack:_ [INT ATK] to hit, range ???/??? ft., one target. _Hit:_ [INT ???D???] ??? damage.",
  },
  {
    name: "Ranged Spell Attack (WIS)",
    type: "action",
    desc: "_Ranged Spell Attack:_ [WIS ATK] to hit, range ???/??? ft., one target. _Hit:_ [WIS ???D???] ??? damage.",
  },
  {
    name: "Ranged Spell Attack (CHA)",
    type: "action",
    desc: "_Ranged Spell Attack:_ [CHA ATK] to hit, range ???/??? ft., one target. _Hit:_ [CHA ???D???] ??? damage.",
  },
  {
    name: "Melee or Ranged Weapon Attack (STR)",
    type: "action",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach ??? ft. or range ???/??? ft., one target. _Hit:_ [STR ???D???] ??? damage.",
  },
  {
    name: "Melee or Ranged Weapon Attack (DEX)",
    type: "action",
    desc: "_Melee or Ranged Weapon Attack:_ [DEX ATK] to hit, reach ??? ft. or range ???/??? ft., one target. _Hit:_ [DEX ???D???] ??? damage.",
  },
  {
  ...
  },
  {
    ...
    desc: "The [MON] is a ???-level spellcaster. Its spellcasting ability is Intelligence (spell save DC [INT SAVE], [INT ATK] to hit with spell attacks). The [MON] has the following ??? spells prepared:\n\n> Cantrips (at will): _spell, spell, spell, spell_\n> 1st level (4 slots): _spell, spell, spell_\n> 2nd level (3 slots): _spell, spell, spell_\n> 3rd level (2 slots): _spell, spell_",
    type: "trait",
  },
  {
    name: "Spellcasting (WIS)",
    realname: "Spellcasting",
    desc: "The [MON] is a ???-level spellcaster. Its spellcasting ability is Wisdom (spell save DC [WIS SAVE], [WIS ATK] to hit with spell attacks). The [MON] has the following ??? spells prepared:\n\n> Cantrips (at will): _spell, spell, spell, spell_\n> 1st level (4 slots): _spell, spell, spell_\n> 2nd level (3 slots): _spell, spell, spell_\n> 3rd level (2 slots): _spell, spell_",
    type: "trait",
  },
  {
    name: "Spellcasting (CHA)",
    realname: "Spellcasting",
    desc: "The [MON] is a ???-level spellcaster. Its spellcasting ability is Charisma (spell save DC [CHA SAVE], [CHA ATK] to hit with spell attacks). The [MON] has the following ??? spells prepared:\n\n> Cantrips (at will): _spell, spell, spell, spell_\n> 1st level (4 slots): _spell, spell, spell_\n> 2nd level (3 slots): _spell, spell, spell_\n> 3rd level (2 slots): _spell, spell_",
    type: "trait",
  },
  {
    name: "Innate Spellcasting (INT)",
    realname: "Innate Spellcasting",
    desc: "The [MON]'s innate spellcasting ability is Intelligence (spell save DC [INT SAVE], [INT ATK] to hit with spell attacks). It can innately cast the following spells, requiring no material components:\n\n> At will: _spell, spell, spell_\n> 3/day each: _spell, spell, spell_\n> 1/day each: _spell, spell_",
    type: "trait",
  },
  {
    name: "Innate Spellcasting (WIS)",
    realname: "Innate Spellcasting",
    desc: "The [MON]'s innate spellcasting ability is Wisdom (spell save DC [WIS SAVE], [WIS ATK] to hit with spell attacks). It can innately cast the following spells, requiring no material components:\n\n> At will: _spell, spell, spell_\n> 3/day each: _spell, spell, spell_\n> 1/day each: _spell, spell_",
    type: "trait",
  },
  {
    name: "Innate Spellcasting (CHA)",
    realname: "Innate Spellcasting",
    desc: "The [MON]'s innate spellcasting ability is Charisma (spell save DC [CHA SAVE], [CHA ATK] to hit with spell attacks). It can innately cast the following spells, requiring no material components:\n\n> At will: _spell, spell, spell_\n> 3/day each: _spell, spell, spell_\n> 1/day each: _spell, spell_",
    type: "trait",
  },
  {
    name: "Aggressive",
  ...
  },
  {
    ...
    desc: "The [MON]'s weapon attacks are magical. When the [MON] hits with any weapon, the weapon deals an extra [???D???] radiant damage (included in the attack).",
    type: "trait",
  },
  {
  ...
  },
  {
    ...
    desc: "The [MON] exhales ??? in a ???-foot cone. Each creature in that area must make a DC ??? Dexterity saving throw, taking [???D???] ??? damage on a failed save, or half as much damage on a successful one.",
    type: "action",
  },
  {
    name: "Breath Weapon (Line, Action)",
    realname: "Breath Weapon (Recharge ???)",
    desc: "The [MON] exhales ??? in a ???-foot line that is ??? feet wide. Each creature in that line must make a DC ??? Dexterity saving throw, taking [???D???] ??? damage on a failed save, or half as much damage on a successful one.",
    type: "action",
  },
  {
    name: "Brute",
  ...
  {
    name: "Charge",
    desc: "If the [MON] moves at least ??? ft. straight toward a target and then hits it with a ??? attack on the same turn, the target takes an extra [???D???] ??? damage. If the target is a creature, it must succeed on a DC ??? Strength saving throw or be knocked prone.",
    type: "action",
  },
  {
  ...
  },
  {
    ...
    realname: "Constrict",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one creature. _Hit:_ [STR ???D???] bludgeoning damage, and the target is grappled (escape DC ???). Until this grapple ends, the creature is restrained, and the [MON] can't constrict another target.",
    type: "action",
  },
  {
    name: "Corrode Metal",
  ...
  {
    name: "Death Burst",
    desc: "When the [MON] dies, it explodes in a burst of ???. Each creature within ??? ft. of it must make a DC ??? Dexterity saving throw, taking [???D???] ??? damage on a failed save, or half as much damage on a successful one.",
    type: "trait",
  },
  {
  ...
  },
  {
    ...
    desc: "As a bonus action, the [MON] can expend a spell slot to cause its melee weapon attacks to magically deal an extra [???D???] radiant damage to a target on a hit. This benefit lasts until the end of the turn. If the [MON] expends a spell slot of 2nd level or higher, the extra damage increases by 1d6 for each level above 1st.",
    type: "bonus_action",
  },
  {
  ...
  },
  {
    ...
    desc: "The [MON] touches another creature. The target magically regains [???D??? + ???] hit points and is freed from any curse, disease, poison, blindness, or deafness.",
    type: "action",
  },
  {
  ...
  {
    name: "Heated Body",
    desc: "A creature that touches the [MON] or hits it with a melee attack while within ??? feet of it takes [???D???] fire damage.",
    type: "trait",
  },
  {
    name: "Heated Weapons",
    desc: "Any metal melee weapon the [MON] wields deals an extra [???D???] fire damage on a hit (included in the attack).",
    type: "trait",
  },
  {
    name: "Hellish Weapons",
    desc: "The [MON]'s weapon attacks are magical and deal an extra [???D???] poison damage on a hit (included in the attacks).",
    type: "trait",
  },
  {
    name: "Hold Breath",
  ...
  {
    name: "Incorporeal",
    desc: "The [MON] can move through other creatures and objects as if they were difficult terrain. It takes [???D???] force damage if it ends its turn inside an object.",
    type: "trait",
  },
  {
  ...
  },
  {
    ...
    desc: "Once per turn, the [MON] can deal an extra [???D???] damage to a creature it hits with a weapon attack if that creature is within 5 ft. of an ally of the [MON] that isn't incapacitated.",
    type: "trait",
  },
  {
    name: "Mimicry",
  ...
  {
    name: "Pounce",
    desc: "If the [MON] moves at least ??? ft. straight toward a target and then hits it with a ??? attack on the same turn, the target takes an extra [???D???] ??? damage. If the target is a creature, it must succeed on a DC ??? Strength saving throw or be knocked prone. If the target is prone, the [MON] can make another ??? attack against it as a bonus action.",
    type: "action",
  },
  {
    name: "Rampage",
  ...
  },
  {
    ...
    desc: "The [MON] deals an extra [???D???] damage when it hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 ft. of an ally of the [MON] that isn't incapacitated and the [MON] doesn't have disadvantage on the attack roll.",
    type: "action",
  },
  {
  ...
  },
  {
    ...
    desc: "If the [MON] surprises a creature and hits it with an attack during the first round of combat, the target takes an extra [???D???] damage from the attack.",
    type: "trait",
  },
  {
    name: "Swarm",
  ...
  },
  {
    ...
    desc: "The [MON] beats its wings. Each creature within ??? ft. of the [MON] must succeed on a DC ??? Dexterity saving throw or take [STR ???D???] bludgeoning damage and be knocked prone. The [MON] can then fly up to half its flying speed.",
    type: "legendary",
  },
  {
    name: "Battleaxe",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D8] slashing damage, or [STR 1D10] slashing damage if used with two hands.",
    type: "action",
  },
  {
    name: "Blowgun",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 25/100 ft., one target. _Hit:_ [DEX 1] piercing damage.",
    type: "action",
  },
  {
    name: "Club",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D4] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Dagger (STR)",
    realname: "Dagger",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ [STR 1D4] piercing damage.",
    type: "action",
  },
  {
    name: "Dagger (DEX)",
    realname: "Dagger",
    desc: "_Melee or Ranged Weapon Attack:_ [DEX ATK] to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ [DEX 1D4] piercing damage.",
    type: "action",
  },
  {
    name: "Dart (STR)",
    realname: "Dart",
    desc: "_Ranged Weapon Attack:_ [STR ATK] to hit, range 20/60 ft., one target. _Hit:_ [STR 1D4] piercing damage.",
    type: "action",
  },
  {
    name: "Dart (DEX)",
    realname: "Dart",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 20/60 ft., one target. _Hit:_ [DEX 1D4] piercing damage.",
    type: "action",
  },
  {
    name: "Flail",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D8] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Glaive",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 10 ft., one target. _Hit:_ [STR 1D10] slashing damage.",
    type: "action",
  },
  {
    name: "Greataxe",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D12] slashing damage.",
    type: "action",
  },
  {
    name: "Greatclub",
  ...
  {
    name: "Greatsword",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 2D6] slashing damage.",
    type: "action",
  },
  {
    name: "Halberd",
  ...
  {
    name: "Handaxe",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ [STR 1D6] slashing damage.",
    type: "action",
  },
  {
    name: "Hand Crossbow",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 30/120 ft., one target. _Hit:_ [DEX 1D6] piercing damage.",
    type: "action",
  },
  {
    name: "Heavy Crossbow",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 100/400 ft., one target. _Hit:_ [DEX 1D10] piercing damage.",
    type: "action",
  },
  {
    name: "Javelin",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach 5 ft. or range 30/120 ft., one target. _Hit:_ [STR 1D6] piercing damage.",
    type: "action",
  },
  {
    name: "Lance",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 10 ft., one target. _Hit:_ [STR 1D12] piercing damage.",
    type: "action",
  },
  {
    name: "Light Crossbow",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 80/320 ft., one target. _Hit:_ [DEX 1D8] piercing damage.",
    type: "action",
  },
  {
    name: "Light Hammer",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ [STR 1D4] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Longbow",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 150/600 ft., one target. _Hit:_ [DEX 1D8] piercing damage.",
    type: "action",
  },
  {
    name: "Longsword",
  ...
  {
    name: "Mace",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D6] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Maul",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 2D6] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Morningstar",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D8] piercing damage.",
    type: "action",
  },
  {
    name: "Net",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 5/15 ft., one Large or smaller creature. _Hit:_ The target is restrained. A creature can use its action to make a DC 10 Strength check to free itself or another creature in a net, ending the effect on a success. Dealing 5 slashing damage to the net (AC 10) frees the target without harming it and destroys the net.",
    type: "action",
  },
  {
    name: "Pike",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 10 ft., one target. _Hit:_ [STR 1D10] piercing damage.",
    type: "action",
  },
  {
    name: "Quarterstaff",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D6] bludgeoning damage, or [STR 1D8] bludgeoning damage if used with two hands.",
    type: "action",
  },
  {
    name: "Rapier (STR)",
  ...
  },
  {
    name: "Rapier (DEX)",
    realname: "Rapier",
    desc: "_Melee Weapon Attack:_ [DEX ATK] to hit, reach 5 ft., one target. _Hit:_ [DEX 1D8] piercing damage.",
    type: "action",
  },
  {
    name: "Scimitar (STR)",
    realname: "Scimitar",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D6] slashing damage.",
    type: "action",
  },
  {
    name: "Scimitar (DEX)",
    realname: "Scimitar",
    desc: "_Melee Weapon Attack:_ [DEX ATK] to hit, reach 5 ft., one target. _Hit:_ [DEX 1D6] slashing damage.",
    type: "action",
  },
  {
    name: "Shortbow",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 80/320 ft., one target. _Hit:_ [DEX 1D6] piercing damage.",
    type: "action",
  },
  {
    name: "Shortsword (STR)",
    realname: "Shortsword",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D6] piercing damage.",
    type: "action",
  },
  {
    name: "Shortsword (DEX)",
    realname: "Shortsword",
    desc: "_Melee Weapon Attack:_ [DEX ATK] to hit, reach 5 ft., one target. _Hit:_ [DEX 1D6] piercing damage.",
    type: "action",
  },
  {
    name: "Sickle",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D4] slashing damage.",
    type: "action",
  },
  {
    name: "Sling",
    desc: "_Ranged Weapon Attack:_ [DEX ATK] to hit, range 30/120 ft., one target. _Hit:_ [DEX 1D4] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Spear",
    desc: "_Melee or Ranged Weapon Attack:_ [STR ATK] to hit, reach 5 ft. or range 20/60 ft., one target. _Hit:_ [STR 1D6] piercing damage, or [STR 1D8] piercing damage if used with two hands to make a melee attack.",
    type: "action",
  },
  {
    name: "Trident",
  ...
  {
    name: "Unarmed Strike",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1] bludgeoning damage.",
    type: "action",
  },
  {
    name: "Warhammer",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 5 ft., one target. _Hit:_ [STR 1D8] bludgeoning damage, or [STR 1D10] bludgeoning damage if used with two hands.",
    type: "action",
  },
  {
    name: "War Pick",
  ...
  },
  {
    name: "Whip (STR)",
    realname: "Whip",
    desc: "_Melee Weapon Attack:_ [STR ATK] to hit, reach 10 ft., one target. _Hit:_ [STR 1D4] slashing damage.",
    type: "action",
  },
  {
    name: "Whip (DEX)",
    realname: "Whip",
    desc: "_Melee Weapon Attack:_ [DEX ATK] to hit, reach 10 ft., one target. _Hit:_ [DEX 1D4] slashing damage.",
    type: "action",
  },
];
