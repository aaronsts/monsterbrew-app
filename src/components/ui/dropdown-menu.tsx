...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-default items-center gap-2 rounded-none px-2 py-2 text-xs outline-hidden select-none focus:bg-accent focus:text-accent-foreground not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-7 data-[variant=destructive]:text-destructive-500 data-[variant=destructive]:focus:bg-destructive-500 data-[variant=destructive]:focus:text-destructive-100 dark:data-[variant=destructive]:text-destructive-300 dark:data-[variant=destructive]:focus:bg-destructive-500/25 dark:data-[variant=destructive]:focus:text-destructive-300 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
