  ...
  "group/alert relative grid w-full gap-0.5 rounded-none border px-2.5 py-2 text-left text-xs has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pr-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive *:data-[slot=alert-description]:text-destructive/90 dark:text-destructive-foreground *:data-[slot=alert-description]:text-destructive-foreground *:[svg]:text-current",
        info: "bg-info border-info-300 text-info-foreground *:data-[slot=alert-description]:text-info-foreground/90 dark:border-info-500 *:[svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
