---
title: Fundamentals of monster design
...
- **Defender:** soaks hits and keeps enemies off its allies, often with "sticky" features that punish walking away. Use sparingly or fights drag.
...
- **More creatures** is the simplest fix. A boss with minions gets the table's initiative count working for it (and gives area-effect characters something satisfying to do).
