...
- **Damage per round** is the creature's whole output for one round, split across its attacks. If an effect hits two or more characters at once — a breath weapon, a burst — budget it at *half* this number.
