...
- Conditions are currency. An attack that also poisons, restrains, or knocks prone is worth more than its dice, so pay for the rider with lower damage on that attack, or fewer attacks.
